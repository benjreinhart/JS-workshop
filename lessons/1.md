...
For instance, if I open my interactive ruby shell up you would notice something like this:
	...
	=> true 
	ruby-1.9.2-p290 :04 > (10).is_a? Fixnum
	=> true
	ruby-1.9.2-p290 :05 > (10).is_a? Float
	=> false 

	ruby-1.9.2-p290 :06 > (10.0).is_a? Float
	=> true
	ruby-1.9.2-p290 :07 > (10.0).is_a? Fixnum
	=> false
	ruby-1.9.2-p290 :08 > (10.0).is_a? Integer
	=> false

	ruby-1.9.2-p290 :09 > (10).class
	 => Fixnum 
