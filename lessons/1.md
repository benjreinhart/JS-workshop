...
For instance, if I open my interactive ruby shell up you would notice something like this:
	...
	=> true 
	ruby-1.9.2-p290 :010 > (10).is_a? Fixnum
	=> true
	ruby-1.9.2-p290 :013 > (10).is_a? Float
	=> false 

	ruby-1.9.2-p290 :009 > (10.0).is_a? Float
	=> true
	ruby-1.9.2-p290 :010 > (10.0).is_a? Fixnum
	=> false
	ruby-1.9.2-p290 :012 > (10.0).is_a? Integer
	=> false

	ruby-1.9.2-p290 :005 > (10).class
	 => Fixnum 
	ruby-1.9.2-p290 :006 > (10.0).class
	 => Float 
