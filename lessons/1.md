...
Note that `var myString = new String("a string!);` and `var myString = "a string!";` are different. One returns a special data type and the other returns a JavaScript object of the `String` class.
