...
Prototype chains is how we link objects together, and methods and properties defined on a `prototype` will be available to any object that shares the same `prototype`.
