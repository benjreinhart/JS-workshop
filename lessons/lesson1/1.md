...
function whichNum(number) {
  switch(number) {
    ...
    case 2:
      ...
      break;
    default:
      console.log("If none of the cases above")
  }
}
...
The switch statement will test a value against a number of different cases and execute a case depending on a value match. If the `break` statement isn't used, execution will fall through until it either hits a break statement, return statement or reaches the end of the switch statement.
