...
Functions in JavaScript are treated as objects in the sense that they can be passed around like any other object. Functions are also used to create instances of objects and therefore classes. 
