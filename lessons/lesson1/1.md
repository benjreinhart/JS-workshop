...
Object literals in JavaScript are key-value pairs. They can be accessed by either square bracket notation `[]` or by the dot `.` notation. However, the dot notation has a few caveats. Each key-value pair is separated by a colon `:`.
