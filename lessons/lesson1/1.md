...
This was nothing but an incredibly brief overview of JavaScript. It was only intended to be a quick overview though, so I recommend reading a number of the resources I outlined on the homepage to for each of the previous sections to gain a lot more information.
